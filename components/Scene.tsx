...
export default function Scene() {
  const models = [
    { name: 'atom.glb', title: 'Atom', content: 'An atom is the basic unit of matter, made up of protons, neutrons, and electrons. The nucleus, at the center, contains protons and neutrons, while electrons orbit around the nucleus in energy levels. Atoms combine to form molecules and make up all substances in the universe.', initialZoom: 2 },
    { name: 'moleculeModel.glb', title: 'Molecule', content: 'Cytosine is one of the four nitrogenous bases found in DNA and RNA, which are essential for genetic coding. It pairs with guanine (G) in DNA through hydrogen bonds. Cytosine is a pyrimidine base, and its structure consists of a six-membered ring containing nitrogen and carbon atoms.', initialZoom: 2 },
    { name: 'DNAHelix.glb', title: 'DNA Helix', content: 'A DNA helix refers to the structure of deoxyribonucleic acid (DNA), which carries genetic information in living organisms. DNA is shaped like a double helix, consisting of two strands twisted around each other. Each strand is made up of nucleotide units that encode genetic instructions for biological functions and development.', initialZoom: 2 },
    { name: 'beaver.glb', title: 'Beaver', content: 'This is a beaver model.', initialZoom: 2 },
    { name: 'earthModel.glb', title: 'Earth', content: 'Earth is the third planet from the Sun and the only known planet to support life. It has a diverse environment, with land, water, and air that sustain a variety of ecosystems. Earth’s atmosphere contains oxygen and nitrogen, and its surface includes oceans, mountains, and forests.', initialZoom: 2 },
    { name: 'solarsystem.glb', title: 'Solar System', content: 'The solar system is a collection of celestial bodies, including the Sun, eight planets (such as Earth and Mars), moons, dwarf planets (like Pluto), asteroids, comets, and other objects. The Sun is at the center, providing gravitational pull and energy that keeps the planets in orbit. The solar system is located in the Milky Way galaxy.', initialZoom: 2 },
    { name: 'Milkywaygalaxy.glb', title: 'Milky Way', content: 'The Milky Way is the galaxy that contains our solar system, and it is a spiral galaxy made up of billions of stars, dust, and gas. It is shaped like a flat disk with spiral arms. The galaxy spans over 100,000 light-years in diameter and is just one of billions of galaxies in the universe.', initialZoom: 2 },
    { name: 'observableuniverse.glb', title: 'Observable Universe', content: 'The observable universe refers to the portion of the entire universe that we can observe from Earth, based on the distance light has traveled since the Big Bang. It spans about 93 billion light-years in diameter. The observable universe includes all the galaxies, stars, planets, and other cosmic objects that emit light or other forms of radiation that we can detect with current technology, like telescopes.', initialZoom: 2 },
  ];
